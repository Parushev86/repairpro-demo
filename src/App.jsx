...
function OrdersTab({orders,allOrders,search,setSearch,filterStatus,setFilterStatus,filterDevice,setFilterDevice,onNew,onEdit,onDelete,onPrint,onLabel,onDownloadTXT,onWarranty,onExport,onImport,inventory,setInventory,upsertOrder}) {
  return (
    <div className="animate-fade">
      ...
      <div className="orders-desktop-table" style={{background:"var(--bg2)",borderRadius:12,overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
        <div style={{minWidth:680}}><table>
      ...
      <div className="orders-mobile-cards">
        {orders.length===0&&<div style={{textAlign:"center",padding:28,color:"var(--text3)",background:"var(--bg2)",borderRadius:12}}>Няма намерени поръчки</div>}
        {orders.map(o=>(
          <div key={o.id+"m"} style={{background:"var(--bg2)",borderRadius:10,padding:"12px 14px",marginBottom:8,borderLeft:"3px solid "+(STATUS_COLOR[o.status]||"#334155")}} onClick={()=>onEdit(o)}>
            ...
            <div style={{fontSize:12,color:"var(--text2)",marginBottom:3}}>{o.device_type} {o.brand} {o.model}</div>
            {o.problem&&<div style={{fontSize:11,color:"var(--text3)",marginBottom:5,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{o.problem}</div>}
            ...
            <div style={{fontSize:11,color:"var(--text3)",marginTop:3}}>{o.phone} · {fmtDate(o.date_in)}{o.technician?" · "+o.technician:""}</div>
          </div>
        ))}
      </div>
    </div>
...
const OrderModal = memo(function OrderModal({order,technicians,inventory,setInventory,onSave,onClose,syncing}) {
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.75)",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:8}}>
...
function InventoryTab({inventory,lowStock,onNew,onEdit,onDelete,onExport,onImport}) {
  ...
  return(
    <div className="animate-fade">
      ...
      <div className="inv-desktop-table" style={{background:"var(--bg2)",borderRadius:12,overflowX:"auto",WebkitOverflowScrolling:"touch"}}><div style={{minWidth:620}}>
        <table>
          <thead style={{background:"#0a1628"}}>
...
function ReportsTab({orders,inventory,technicians,onExport}) {
  ...
  return(
    <div className="animate-fade">
      ...
      {filtered.length>0&&<Card style={{padding:0,overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
...
function TechniciansTab({technicians,orders,onSave,onDelete,onExport}) {
  ...
  return(
    <div className="animate-fade">
      ...
      <div className="tech-grid" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14}}>
        {technicians.map((t,i)=>{
...
function DailyReport({orders, inventory, expenses=[], accSales=[], partsSales=[], phoneSales=[], cashReg=[]}) {
  ...
  return (
    <div className="animate-fade">
      ...
      {/* By technician */}
      {techDay.length > 0 && (
        <Card style={{marginBottom:18,overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
      ...
      {issuedToday.length > 0 && (
        <Card style={{marginBottom:18,padding:0,overflowX:"auto",WebkitOverflowScrolling:"touch"}}>
...
function PricingTab() {
  ...
  return (
    <div className="animate-fade">
      ...
      {/* Service tabs */}
      <div style={{display:"flex",gap:8,marginBottom:18,overflowX:"auto",WebkitOverflowScrolling:"touch",paddingBottom:4,flexWrap:"nowrap"}}>
