    ...
    <div className="animate-fade">
      ...
      <Card style={{ marginBottom:16, padding:"14px 18px" }}>
        ...
        <div style={{ display:"flex", gap:6, marginTop:12, flexWrap:"wrap" }}>
          {[["period","📊","Обобщение"],["tech","👨‍🔧","По техник"],["monthly","📅","Месечна таблица"]].map(([key,icon,label]) => (
          ...
          <Card>
            ...
            <div className="table-wrap">
              <table style={{ width:"100%", borderCollapse:"collapse" }}>
                ...
                )) : <tr><td colSpan={4} style={{ padding:20, textAlign:"center", color:"var(--text3)", fontSize:12 }}>Няма данни за периода</td></tr>}
                </tbody>
              </table>
            </div>
          </Card>
